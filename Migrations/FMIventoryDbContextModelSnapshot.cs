...
namespace FieldMRIServices.Migrations
{
    ...
    partial class FMIventoryDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.DVD", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.DVDModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.DVDPhotoModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.InventoryPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.Other", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.OtherPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.DVDPhotoModel", b =>
                {
                    b.HasOne("FieldMRIServices.Entities.DVD", "DVD")
                        .WithMany("DVDPhoto")
                        .HasForeignKey("DVDId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FieldMRIServices.Entities.DVDModel", null)
                        .WithMany("DVDPhoto")
            ...
            modelBuilder.Entity("FieldMRIServices.Entities.OtherPhoto", b =>
                {
                    b.HasOne("FieldMRIServices.Entities.Other", "Other")
                        .WithOne("OtherPhoto")
                        .HasForeignKey("FieldMRIServices.Entities.OtherPhoto", "OtherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
