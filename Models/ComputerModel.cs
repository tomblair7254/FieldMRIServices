...
namespace FieldMRIServices.Model
{
    public class ComputerModel : ISortableModel
    {
        ...
        public string I394 { get; set; } = "none,cell";
        ...
        public string? SelectedI394color { get; set; } = "none";
        ...
        public void UpdateAllProperties()
        {
            ...
            UpdateProperty(ref floppy, SelectedI394color ?? "none", "cell");
        ...
        public string I394FirstPart
        {
            ...
            set
            {
                if (I394 != null)
                {
                    var parts = I394.Split(',');
                    parts[0] = value;
                    I394 = string.Join(",", parts);
                }
                else
                {
                    I394 = value;
            ...
            var properties = new (string Property, Action<string> SetColor)[]
            {
             ...
             (SASRaid, color => SelectedSASRaidcolor = color),
              ...
              (Usb, color => SelectedUsbcolor = color),
                ...
                (I394, color => SelectedI394color = color),
            };
