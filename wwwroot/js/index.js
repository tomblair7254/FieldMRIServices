    ...
    const applyColors = () => {
        ...
        rows.forEach(row => {
            ...
            if (inventory.SelectedScope === "Row") {
                row.style.backgroundColor = inventory.SelectedColour.toLowerCase();
                console.log(`Row color set to ${inventory.SelectedColour.toLowerCase()}`);
                ...
                cells.forEach(cell => {
                    if (cell.getAttribute('data-field') === 'TagFirstPart') {
                        cell.style.backgroundColor = inventory.SelectedColour.toLowerCase();
                        console.log(`Cell color set to ${inventory.SelectedColour.toLowerCase()} for field TagFirstPart`);
                    }
                });
            }
        });
